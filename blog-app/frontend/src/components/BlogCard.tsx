...
export const BlogCard = (
    ...
    return ( <Link to={`/blog/${id}`} >
        <div className="border-b-1 border-slate-200 p-5 m-6 max-w-screen-md break-words cursor-pointer" >
            <div className="flex " >
                  <Avatar size={"small"} name={authorName}/>
                <div className="font-extralight pl-1 flex justify-center flex-col " >{authorName}</div>
